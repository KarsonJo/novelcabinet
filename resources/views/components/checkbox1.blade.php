<div class="inline-flex items-center w-full aspect-square">
    <label class="relative flex cursor-pointer items-center rounded-full w-full h-full" for="{{ $domId }}">
        <input id="{{ $domId }}" type="checkbox" class="peer w-full h-full cursor-pointer appearance-none rounded-md border border-quaternary transition-all focus:ring-2 focus:ring-theme-bg1 checked:border-theme-bg1 checked:bg-theme-bg1" />
