<div class="tag.book group/book w-full h-full select-none relative">
        {{-- Inner --}}
    ...
    group-hover/book:translate-book1-open overflow-hidden">
        {{-- Cover --}}
        @if ($coverImage)
        ...
        group-hover/book:opacity-100 group-hover/book:w-8/12"></div>
    </div>
