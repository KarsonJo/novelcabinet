<div>
    ...
    <label class="inline-block relative w-16 h-6 rounded-full bg-quaternary-bg transition cursor-pointer peer-checked:[&_label]:left-full peer-checked:[&_label]:-translate-x-full peer-checked:bg-green-400" for="{{ $id }}">
